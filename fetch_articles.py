...
print(“[INFO] No ANTHROPIC_API_KEY - using raw summaries”)
for a in articles:
...
print(“ [WARN] Claude enrichment failed: “ + str(e))
for a in batch:
a[“summary”] = a[“raw_summary”] or ““
a[“tags”] = []
enriched.extend(batch)
...
print(“ Done! Written articles.json with “ + str(len(enriched)) + “ articles”)
```
